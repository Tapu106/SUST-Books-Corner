			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Course Type</h2>	
					</div>
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/save-course-type')}}" method="post">
						{{ csrf_field() }} 
						  <fieldset>
							
							<div class="control-group">
							  <label class="control-label" for="date01">Course Type</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="course_type_name" required="" >
							  </div>
							</div>
